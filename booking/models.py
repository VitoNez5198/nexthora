...
class Appointment(models.Model):
    ...
    client_rut = models.CharField(max_length=12, verbose_name="RUT", default="") # Nuevo
    client_email = models.EmailField(verbose_name="Email")
    client_whatsapp = models.CharField(max_length=20, verbose_name="WhatsApp", default="") # Reemplaza a phone
    
    # ... (fechas y estados siguen igual) ...
